...
var setupTests = []setupTest{{
	...
	summary: "Conflicting globs with trailing **",
	input: map[string]string{
		"slices/mydir/mypkg1.yaml": `
			package: mypkg1
			slices:
	...
	relerror: `slices mypkg1_myslice and mypkg2_myslice conflict on /path/ab\*cd/\*\* and /path/ab12cd/`,
}, {
	...
	summary: "** checks all paths with the same prefix",
	input: map[string]string{
		"slices/mydir/mypkg1.yaml": `
			package: mypkg1
			slices:
	...
	relerror: `slices mypkg1_myslice and mypkg2_myslice conflict on /path/\*\*/file and /path/subdir/file`,
}, {
	...
	summary: "Glob conflicts with directory that also has children",
	input: map[string]string{
		"slices/mydir/mypkg.yaml": `
			package: mypkg
			slices:
	...
	relerror: `slices mypkg_myslice and mypkg_myslice conflict on /a/ and /a/\*`,
}, {
