...
func Run(options *RunOptions) error {
	...
	if options.PreviousManifest != nil {
		err = upgrade(targetDir, installOpts.TargetDir, report, options.PreviousManifest)
		if err != nil {
			return err
		}
	}
...
func upgrade(targetDir string, tempDir string, report *manifestutil.Report, prevManifest *manifest.Manifest) error {
